...
public class HelloController {
    ...
    @RequestMapping(value = "/ceateUsers",method = RequestMethod.GET)
    @ResponseBody
    public void createUsers(@RequestParam("id")int id ,@RequestParam("name")String name,@RequestParam("pwd")String pwd,@RequestParam("usertype")int usertype){
        usersService.createUsers(id,name,pwd,usertype);
    }
}
